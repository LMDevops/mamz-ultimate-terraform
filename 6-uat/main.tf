module "app1_uat_project" {
  ...
  folder_id          = data.terraform_remote_state.organization.outputs.folders.fldr-uat.name
...
module "app1_uat_admin_iam" {
  source           = "../modules/iam/projects-iam"
  project_id       = trimprefix(module.app1_uat_project.project_id, "projects/")
  admin_roles      = local.admin_roles
  admin_group_name = var.admin_group_name
}

module "app1_uat_developer_iam" {
  source               = "../modules/iam/projects-iam"
  project_id           = trimprefix(module.app1_uat_project.project_id, "projects/")
